...
const WirelineCommunicationICs = () => {
    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 mb-6 leading-relaxed pb-2">
          Wireline Communication ICs
        </h1>
        <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          <span className="text-cyan-400 font-semibold">Advanced High-Speed Data Transmission</span> solutions for modern communication systems
        </p>
      </motion.div>
          ...
          >
            ...
            <div className="text-lg w-full max-w-4xl">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                Our Wireline Communication ICs provide comprehensive solutions for high-speed data transmission, featuring SERDES, CDR, Clock Synthesizer, and Multi-Standard Transceivers for demanding communication applications.
              </p>
              ...
              <ul className="text-gray-300 space-y-3 list-disc list-inside mb-8">
                <li>High-performance SERDES technology</li>
                <li>Advanced Clock and Data Recovery (CDR) circuits</li>
                <li>Precision Clock Synthesizer for jitter-sensitive applications</li>
                <li>Multi-Standard Transceivers for versatile connectivity</li>
                <li>Integrated Equalizer for signal integrity</li>
                <li>Encoder/Decoder (ENDEC) functionality</li>
              ...
              <ul className="text-gray-300 space-y-3 list-disc list-inside mb-8">
                <li>High-speed data communication systems</li>
                <li>Network infrastructure equipment</li>
...
export default WirelineCommunicationICs;
