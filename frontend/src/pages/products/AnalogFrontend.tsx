    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        ...
        <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          <span className="text-cyan-400 font-semibold">Precision Signal Processing Solutions</span> for sensor data acquisition
        </p>
      </motion.div>
          ...
          >
            ...
            <div className="text-lg w-full max-w-4xl">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                Our Analog Frontend solution is specifically designed for sensor data acquisition in IoT devices, providing a complete signal chain solution that bridges the analog sensor world with digital processing.
              </p>
              ...
              <ul className="text-gray-300 space-y-3 list-disc list-inside mb-8">
                <li>Optimized for low-power IoT sensor nodes</li>
                <li>Integrated signal conditioning and data conversion</li>
                <li>Low-noise design for high-precision measurements</li>
                <li>Configurable for various sensor types</li>
                <li>Small form factor for space-constrained applications</li>
              </ul>
              ...
              <ul className="text-gray-300 space-y-3 list-disc list-inside mb-8">
                ...
                <li>Environmental sensing networks</li>
                <li>Industrial IoT sensor nodes</li>
                <li>Battery-powered sensor applications</li>
              </ul>
