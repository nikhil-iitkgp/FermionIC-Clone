    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white flex flex-col overflow-x-hidden">
      ...
      >
        ...
        <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          <span className="text-cyan-400 font-semibold">Integrated Wireless Connectivity Solutions</span> for next-generation IoT applications
        </p>
      </motion.div>
        ...
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700/50 shadow-2xl rounded-xl p-8 relative overflow-hidden group">
          ...
          >
            ...
            <div className="text-lg w-full max-w-4xl">
              <h3 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400 mb-6 leading-relaxed pb-1">Features</h3>
              <ul className="text-gray-300 space-y-3 list-disc list-inside mb-8">
                <li>Multi-protocol support: Wi-Fi 6, Bluetooth 5.2, Zigbee 3.0, Thread, and Matter</li>
                <li>Dual-core 240MHz Xtensa® 32-bit LX7 processor</li>
                <li>Ultra-low power consumption: 5μA in deep sleep mode</li>
                <li>Integrated power amplifier with +20dBm output power</li>
                <li>Secure boot and flash encryption</li>
                <li>Rich peripheral set: USB, SPI, I2C, UART, I2S, ADC, DAC</li>
                <li>Operating temperature: -40°C to +125°C</li>
                <li>Compact 6mm × 6mm QFN package</li>
              </ul>
...
export default CommunicationSoCs;
