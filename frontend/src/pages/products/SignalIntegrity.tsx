    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white flex flex-col">
      ...
      >
        <div className="flex flex-col items-center space-y-8">
          ...
          >
            <motion.img
              src="https://static.wixstatic.com/media/ee7e9e_3b4106ac1dd64578a8cf6e9094a605b9~mv2.png/v1/fill/w_1633,h_321,al_c,q_90,enc_avif,quality_auto/Redriver_use.png"
              alt="High Current LDO IC"
          ...
          <div className="text-lg w-full max-w-4xl">
            ...
            <ul className="text-gray-300 space-y-2 list-disc list-inside">
              <li>&lt; 1.5% Line and Load Regulation</li>
              <li>Load Current 1.5A</li>
            ...
            <ul className="text-gray-300 space-y-2 list-disc list-inside mb-8">
              <li>Low noise active antenna system MIMO</li>
