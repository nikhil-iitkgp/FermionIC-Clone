...
const siliconIPData = [
  {
    ...
    description:
      "Data rate 5 to 10Gbps Multi Standard Transceivers, PLLs, Synthesizer, Clock and Data Recovery unit, Integrated Data Encoder, JESD, JTAG, USB 3.0",
    icon: Cpu,
  ...
  },
  {
    ...
    description:
      "Pipeline ADC, SAR ADC, Delta Sigma ADC, Dual Slop ENOB : 8 to 16 bits Sampling Rate : 10 to 500 MSPS",
    icon: Activity,
  ...
  },
  {
    ...
    description:
      "LDOs, Digital LDOs, Switched Capacitor DC-DC Converters, Inductor based Buck-Boost Converts, Multi-Mode Energy Harvesting Units, Battery Charging interface, Output Power levels: 100uA to 3A",
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "Several Radiation Hardened by Design (RHBD) IPs, with SET tolerant Circuit schemes",
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Compute cores for AI accelerator, In-Memory Compute cores for Deep Neural Network and Spiking Neural Network, Multi-core architectures for CNN models, suitable for low power edge computing applications",
    icon: Brain,
  ...
  },
  {
    ...
    description:
      "Signal Acquisition and Signal Conditioning Units, comprising of Low Noise Amplifier,VGA, SC Filters, DC Servo Loop, Chopper\nStabilization, Impedance Boosting, Offset Trimming,Current Conveyer Architecture for ultra low current sensing",
    icon: Radio,
